                        ...
                        if (_pickingType == FileType.video)
                          {
                            _scaffoldKey.currentState.showSnackBar(
                              SnackBar(
                                ...
                                content: Text("Bro porn thodi upload krni he"),
                              ),
                            ),
                          }
                        else
...
//         if (_multiPick) {
//           _path = null;
//           _paths = await FilePicker.getMultiFilePath(type: _pickingType , allowedExtensions: ['jpg', 'pdf', 'doc']);
//         } else {
//           _paths = null;
//           _path = await FilePicker.getFilePath(type: _pickingType, allowedExtensions: ['jpg', 'pdf', 'doc']);
//         }
//       } on PlatformException catch (e) {
//         print("Unsupported operation" + e.toString());
//       }
