...
class SubjectPageque extends StatefulWidget {
  var sub;
  SubjectPageque(this.sub);
  @override
  _SubjectPagequeState createState() => _SubjectPagequeState(this.sub);
}

class _SubjectPagequeState extends State<SubjectPageque> {
 
  var _searchedText;
  var subject;
  _SubjectPagequeState(this.subject);
